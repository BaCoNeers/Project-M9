...
#pragma config(Motor,  mtr_S1_C1_1,     undef1,        tmotorMatrix, PIDControl)
#pragma config(Motor,  mtr_S1_C1_2,     undef2,        tmotorMatrix, PIDControl)
#pragma config(Motor,  mtr_S1_C2_1,     motorD,        tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C2_2,     motor4,        tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C3_1,     unfef3,        tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C3_2,     motorE,        tmotorTetrix, PIDControl)
