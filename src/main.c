...
#pragma config(Motor,  mtr_S1_C1_1,     motorD,        tmotorMatrix, PIDControl)
#pragma config(Motor,  mtr_S1_C1_2,     motorE,        tmotorMatrix, PIDControl)
...
#pragma config(MotorPidSetting,  mtr_S1_C3_2,  1, 255, 2000, 2, 0,   32767, 32767, 32767)
