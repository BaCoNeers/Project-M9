/*
* Team Bacon Servo/Motor Controller Device Driver - UPDATED 24/10/2014
* This file is an modified version of the "HiTechnic Servo/Motor Controller Device Driver  - UPDATED 1/08/2009"
*
...
/*
* Wait for Start
* Include a wait for start message on the screen.
*
...
void waitForStart()
{
  ...
  while (true)
  {
    ...
    // Display Wating for Start message.
    eraseDisplay();
